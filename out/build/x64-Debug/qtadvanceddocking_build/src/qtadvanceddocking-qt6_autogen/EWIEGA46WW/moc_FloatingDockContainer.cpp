...
#include "../../../../../../../libs/Qt-Advanced-Docking-System/src/FloatingDockContainer.h"
...
struct qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS_t qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSadsSCOPECFloatingDockContainerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ads::CFloatingDockContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSadsSCOPECFloatingDockContainerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ads::CFloatingDockContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSadsSCOPECFloatingDockContainerENDCLASS.stringdata0))
